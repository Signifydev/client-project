    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-lg shadow-xl max-w-5xl w-full mx-auto max-h-[90vh] overflow-y-auto">
        ...
        {isLoading ? (
          ...
          <div className="p-8">
            {/* Personal Information Card - Updated layout */}
            <div className="bg-white shadow-sm rounded-xl border border-gray-200 mb-6">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  {/* Right Column - Customer and Business Info */}
                  <div className="space-y-4">
                    <div>
            ...
            {/* Business Information Card - New Section */}
            ...
            {/* Loan Information Section - Updated font sizes */}
            <div className="bg-white shadow-sm rounded-xl border border-gray-200 mb-8">
                ...
                {loans.length > 0 ? (
                  <div className="space-y-6">
                    {loans.map((loan: Loan, index: number) => {
                      ...
                      const remainingAmount = Math.round((loan.amount || 0) * (1 - completion.completionPercentage/100));
                      ...
                      return (
                        <div key={loan._id || index} className="border border-gray-300 rounded-xl p-6 hover:shadow-lg transition-all">
                          ...
                          {/* Completion Percentage - Moved to the top */}
                          <div className="mb-6 bg-blue-50 p-4 rounded-xl border border-blue-100">
                            ...
                            <div className="flex justify-between items-center text-xs">
                              <div className="text-gray-600">
                                <span>Paid: </span>
                                <span className="font-semibold">₹{Math.round((loan.amount || 0) * (completion.completionPercentage/100))}</span>
                              </div>
                              <div className="text-gray-600">
                                <span>Remaining: </span>
                                <span className="font-semibold">₹{remainingAmount} of ₹{loan.amount?.toLocaleString()}</span>
                              </div>
                            </div>
                          </div>

                          {/* Loan Stats Grid - Following the completion section */}
