...
emiPaymentSchema.pre('save', async function() {
  ...
  // Ensure originalEmiAmount is set for reference
  if (!this.originalEmiAmount && this.amount) {
...
// Static method to get payment summary by payment type
