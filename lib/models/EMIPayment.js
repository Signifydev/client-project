...
/**
 * Generate partial chain ID with installment number (INDUSTRY STANDARD)
 */
...
const emiPaymentSchema = new mongoose.Schema({
  ...
  // ==============================================
  // ✅ UPDATED: PARTIAL PAYMENT CHAIN TRACKING WITH INSTALLMENT NUMBER
  // ==============================================
  partialChainId: {
    type: String,
    default: null,
  ...
  // ✅ NEW: Store which installment this payment is for
  installmentNumber: {
    type: Number,
    default: 1,
    min: 1
  },
  // ✅ NEW: Store expected due date for this installment
  expectedDueDate: {
    type: String,
    default: null,
    validate: {
...
// ==============================================
// ✅ UPDATED INDEXES FOR INSTALLMENT-BASED QUERIES
// ==============================================
...
// ==============================================
// ✅ UPDATED: PRE-SAVE HOOK WITH INSTALLMENT NUMBER
// ==============================================
emiPaymentSchema.pre('save', async function() {
  ...
  // ==============================================
  // ✅ FIXED: PARTIAL CHAIN MANAGEMENT WITH INSTALLMENT NUMBER
  // ==============================================
...
// ==============================================
// ✅ UPDATED: STATIC METHODS FOR INSTALLMENT-BASED CHAINS
// ==============================================
...
// ✅ UPDATED: Get payments in a chain with installment context
...
emiPaymentSchema.statics.updateChainTotals = async function(chainId) {
  ...
  console.log('🔗 Chain totals updated (with installment):', {
    chainId,
    installmentTotalAmount,
...
// ✅ UPDATED: Complete partial payment
...
// ✅ UPDATED: Get chain summary with installment context
...
// Existing methods (unchanged but keep them)
